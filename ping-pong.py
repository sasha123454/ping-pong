...
class Player(GameSprite):
    ...
    def update(self):
        ...
        if keys[K_DOWN] and self.rect.y < win_wight - 80:
            self.rect.y -= self.speed
...
racket1 = Player('racket.png',30, 200, 4, 50, 5)
racket2 = Player('racket.png',520, 200, 4, 50, 5)
ball = GameSprite('ball.png',200, 200, 4, 50, 3)
